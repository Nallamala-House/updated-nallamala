  ...
  useEffect(() => {
    if (selectedMember?.github === "https://github.com/PRODHOSH") {
      ...
      fetch('https://api.github.com/search/commits?q=repo:Nallamala-House/updated-nallamala+author:PRODHOSH&per_page=100', {
        ...
        .then(res => res.headers.get("content-type")?.includes("application/json") ? res.json() : Promise.reject("Invalid JSON"))
        .then(data => {
        ...
        .then(commits => {
          if (Array.isArray(commits)) {
            ...
            const commitPromises = commits.map(commit =>
              fetch(commit.url).then(res => res.headers.get("content-type")?.includes("application/json") ? res.json() : Promise.reject("Invalid JSON"))
            )
    ...
    "2025-26": {
      UHC: [
        {
          ...
          linkedin: "https://www.linkedin.com/in/nikhil-kumar-000b20297?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
          image: null,
        ...
        },
        {
          ...
          linkedin: "https://www.linkedin.com/in/jiteshkumar170304/",
          image: "/images/2025-26/deputy_sec.jpg",
          bio: "Student of BS in Electronic Systems at IIT Madras, currently in the final term of the Diploma level. With a strong interest in electronics systems, coordination, and structured execution of academic and organizational initiatives.\n\nPreviously served as Regional Coordinator – Chennai, where he coordinated regional-level activities, facilitated communication between central leadership and local teams, and supported planning, reporting, and on-ground execution to ensure smooth operations.\n\nAlso worked as a Group Leader (Group No. 522), overseeing group coordination, ensuring timely communication, effective task execution, and strict adherence to guidelines. These roles have strengthened his leadership, coordination, and organizational skills, along with his ability to work efficiently in team-driven environments.",
      ...
      LHC: [
        ...
        },
        {
          ...
          image: "/images/2025-26/rc_banglore.jpeg",
      ...
      WEBOPS: [
        ...
        },
        {
          ...
          email: "25f2004002@ds.study.iitm.ac.in",
        ...
        },
        {
          ...
          email: "24f2007601@ds.study.iitm.ac.in",
        ...
        },
        {
          ...
          email: "23f3001384@ds.study.iitm.ac.in",
          linkedin: "",
          image: "/images/2025-26/graphic_designer_2.jpeg",
          bio: "From Hyderabad, I have joined as a content writer and looking forward to meet you all and network for learning and creating impact.",
        },
      ],
      COMMUNITY: [
        {
            ...
            <div className="glass p-2 rounded-2xl border border-primary/30 inline-flex gap-2">
              {Object.entries(teamLabels).map(([key, label], index) => (
                <button
                  ...
                  className={`relative px-8 py-4 rounded-xl font-bold transition-all duration-500 overflow-hidden group ${selectedTeam === key
            ...
            <div className="flex justify-center gap-2 mb-8 flex-wrap animate-fade-in">
              {Object.entries(subTeamLabels).map(([key, label], index) => (
                <button
                  ...
                  className={`relative px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 overflow-hidden group ${selectedSubTeam === key
